...
#define ABL_IMAGE_TYPE_ID_GUID                { 0x9BD69CBE, 0x144E, 0xA451, { 0x51, 0xCA, 0xF0, 0x66, 0x19, 0xDD, 0x96, 0x67 } }

IMAGE_DESCRIPTOR mImageDescriptor_ABL =
{
  {
    ...
    1,                                                     // ImageIndex;
    {0x0},                                                 // Reserved
    ABL_IMAGE_TYPE_ID_GUID,                                    // ImageTypeId;
    IMAGE_ID,                                              // ImageId;
  ...
  )
{
  ...
  SystemFmpPrivate->ImageDescriptor = (EDKII_SYSTEM_FIRMWARE_IMAGE_DESCRIPTOR *)&mImageDescriptor_ABL;//PcdGetPtr (PcdEdkiiSystemFirmwareImageDescriptor);
