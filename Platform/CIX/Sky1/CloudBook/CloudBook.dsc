...
################################################################################
[Defines]
  PLATFORM_NAME                  = CloudBook
  PLATFORM_GUID                  = D9C8A18B-549D-4674-94B7-CFF8E73D55AD
...
##################################################
# Define override here for CloudBook
##################################################
...
[LibraryClasses.common]
  PinMuxTableLib|Platform/CIX/Sky1/CloudBook/Library/PinMuxTableLib/PinMuxTableLib.inf
  GpioTableLib|Platform/CIX/Sky1/CloudBook/Library/GpioTableLib/GpioTableLib.inf
  PlatformConfigParamsHookLib|Platform/CIX/Sky1/Library/PlatformConfigParamsHookLib/PlatformConfigParamsHookLib.inf
  PlatformEnvHookLib|Platform/CIX/Sky1/CloudBook/Library/PlatformEnvHookLib/PlatformEnvHookLib.inf
  RealTimeClockLib|Platform/CIX/Sky1/Library/Ra8900ceRealTimeClockLib/Ra8900ceRealTimeClockLib.inf

  PlatformBootHookLib|Platform/CIX/Sky1/CloudBook/Library/PlatformBootHookLib/PlatformBootHookLib.inf
...
[LibraryClasses.common.DXE_RUNTIME_DRIVER]
  EfiResetSystemLib|Platform/CIX/Sky1/CloudBook/Library/ArmPsciResetSystemLib/ArmPsciResetSystemLib.inf
...
!if $(ACPI_ENABLE) == TRUE
  Platform/CIX/Sky1/CloudBook/Drivers/AcpiPlatfomTables/AcpiPlatfomTables.inf
  Platform/CIX/Sky1/CloudBook/Drivers/AcpiPlatformDxe/AcpiPlatformDxe.inf
!endif
!if $(SMBIOS_ENABLE) == TRUE
  Platform/CIX/Sky1/CloudBook/Drivers/PlatformSmbios/PlatformSmbios.inf
!endif
...
!endif
  ...
  gArmTokenSpaceGuid.PcdProcessorVersion|L"CIX P1 CP6180"
  ...
  gCixTokenSpaceGuid.PcdPcieRootPort0Enable|FALSE  # NC
  gCixTokenSpaceGuid.PcdPcieRootPort1Enable|TRUE   # SSD
  gCixTokenSpaceGuid.PcdPcieRootPort2Enable|FALSE  # NC
  gCixTokenSpaceGuid.PcdPcieRootPort3Enable|FALSE  # NC
  gCixTokenSpaceGuid.PcdPcieRootPort4Enable|TRUE   # WLAN
  ...
  gCixTokenSpaceGuid.PcdI2c0En|TRUE        # TOUCH SCREEN
  gCixTokenSpaceGuid.PcdI2c0BusFreq|400000
  gCixTokenSpaceGuid.PcdI2c1En|FALSE       # NC
  gCixTokenSpaceGuid.PcdI2c1BusFreq|100000
  gCixTokenSpaceGuid.PcdI2c2En|TRUE        # TOUCH PAD
  gCixTokenSpaceGuid.PcdI2c2BusFreq|100000
  gCixTokenSpaceGuid.PcdI2c3En|TRUE        # RTC
  gCixTokenSpaceGuid.PcdI2c3BusFreq|100000
  gCixTokenSpaceGuid.PcdI2c4En|FALSE       # NC
  gCixTokenSpaceGuid.PcdI2c4BusFreq|100000
  gCixTokenSpaceGuid.PcdI2c5En|TRUE        # EC
  gCixTokenSpaceGuid.PcdI2c5BusFreq|100000
  gCixTokenSpaceGuid.PcdI2c6En|TRUE        # EC
  gCixTokenSpaceGuid.PcdI2c6BusFreq|50000
  gCixTokenSpaceGuid.PcdI2c7En|TRUE        # PD
  gCixTokenSpaceGuid.PcdI2c7BusFreq|100000

  gCixPlatformTokenSpaceGuid.PcdPdDevI2cBuses|{ 0x7, 0xFF, 0xFF, 0xFF }
  gCixPlatformTokenSpaceGuid.PcdPdDevI2cSlaveAddresses|{ 0x30, 0xFF, 0xFF, 0xFF }
  gCixPlatformTokenSpaceGuid.PcdPdDevAlertPins|{ 8, 0xFF, 0xFF, 0xFF }

  # I2C EC
  gCixPlatformTokenSpaceGuid.PcdEcI2cBus|5
  gCixPlatformTokenSpaceGuid.PcdEcI2cSlaveAddress|0x71

  # RTC I2C canot be controlled in setup
  gCixTokenSpaceGuid.PcdI2cCtrlEn|0xF7

  # USB3_A
  gCixTokenSpaceGuid.PcdUsb3Control0Enable|TRUE  # SUB USBA
  gCixTokenSpaceGuid.PcdUsb3Control1Enable|TRUE  # USBA

  # USBC0
  gCixTokenSpaceGuid.PcdUsbCDrdControl0Enable|TRUE    # USB3.0 C
  gCixTokenSpaceGuid.PcdUsbCDrdControl0DataRole|FALSE
  # USBC1
  gCixTokenSpaceGuid.PcdUsbCControl0Enable|TRUE       # HDMI
  # USBC2
  gCixTokenSpaceGuid.PcdUsbCControl1Enable|FALSE      # NC
  # USBC3
  gCixTokenSpaceGuid.PcdUsbCControl2Enable|FALSE      # NC

  gCixTokenSpaceGuid.PcdUsb2Control0Enable|FALSE      # NC
  gCixTokenSpaceGuid.PcdUsb2Control1Enable|TRUE       # CAMERA USB
  gCixTokenSpaceGuid.PcdUsb2Control2Enable|TRUE       # BT USB
  gCixTokenSpaceGuid.PcdUsb2Control3Enable|TRUE       # FPR USB
...
[PcdsDynamicDefault.common]
  ...
  gEmbeddedTokenSpaceGuid.PcdDmaDeviceLimit|0x27fffffff
  ...
  # I2C HID device
  gCixPlatformTokenSpaceGuid.PcdHidI2cBus|6
  gCixPlatformTokenSpaceGuid.PcdHidI2cSlaveAddress|0x70
  gCixPlatformTokenSpaceGuid.PcdHidI2cIrqPin|7
