  ...
  )
{
  ...
  EFI_GUID gPkcs7CertDataGuid = { 0x8943387b, 0xc4ad, 0x3199, {0x42, 0xa9, 0xda, 0xbc, 0x5b, 0x41, 0x16, 0x15 }};
...
//  UINTN                                   SystemFirmwareImageSize;
  ...
  *LastAttemptVersion = 0;
  ...
  DEBUG ((DEBUG_INFO, "[ABL]AuthenticatedImage success\n"));
...
//  UINTN                                   SystemFirmwareImageSize;
  ...
  *LastAttemptVersion = 0;
  ...
  DEBUG ((DEBUG_INFO, "AuthenticatedImage - 0x%x - 0x%x\n", *AuthenticatedImage, *AuthenticatedImageSize));
  DEBUG ((DEBUG_INFO, "[BIOS]AuthenticatedImage success\n"));
...
IMAGE_DESCRIPTOR mImageDescriptor_1 =
{
  {
...
{
  mImageFmpInfoSize = sizeof(mImageDescriptor_1);//PcdGetSize (PcdEdkiiSystemFirmwareImageDescriptor);
  mImageFmpInfo     = (EDKII_SYSTEM_FIRMWARE_IMAGE_DESCRIPTOR *)&mImageDescriptor_1;//PcdGetPtr (PcdEdkiiSystemFirmwareImageDescriptor);
  //
