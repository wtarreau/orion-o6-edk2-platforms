...
IMAGE_DESCRIPTOR mImageDescriptor_Bios =
{
  {
  ...
  )
{
  ...
  SystemFmpPrivate->ImageDescriptor = (EDKII_SYSTEM_FIRMWARE_IMAGE_DESCRIPTOR *)&mImageDescriptor_Bios;//PcdGetPtr (PcdEdkiiSystemFirmwareImageDescriptor);
